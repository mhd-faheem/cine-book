  ...
  return (
    <div className='main-wrapper'>
      ...
      <div className='flex justify-center'>
        <div className="booking-details flex flex-col p-8 bg-gray-100 w-1/3 border rounded border-dashed mt-10">
          <div className='flex justify-center'>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <div className='flex justify-center'>
              <button className='p-3 bg-red-400 text-white rounded-xl mt-6 cursor-pointer'>Confirm payment</button>
            </div>
          </div>
      </div>
      </div>
